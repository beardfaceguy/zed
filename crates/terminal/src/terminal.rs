...
mod tests {
    ...
    async fn test_display_only_terminal_scrollback_bounded(cx: &mut TestAppContext) {
        ...
        for index in 0..scrollback_limit * 5 {
        ...
        let total = terminal.read_with(cx, |terminal, _cx| terminal.total_lines());
        let viewport = terminal.read_with(cx, |terminal, _cx| terminal.viewport_lines());
